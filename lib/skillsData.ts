...
export const rowOne: SkillItem[] = [
  ...
  },
  {
    ...
    category: "Languages",
    description: "High-performance language offering low-level memory control and efficiency.",
  },
  {
    name: "go",
    label: "Go",
    ...
    url: "https://go.dev/",
    category: "Languages",
    description: "Compiled, concurrent language built by Google for scalable cloud services.",
  },
  {
    name: "mysql",
    label: "MySQL",
  ...
  },
  {
    ...
    category: "Databases",
    description: "Advanced open-source object-relational database with strong ACID compliance.",
  },
  {
    name: "mongodb",
    label: "MongoDB",
  ...
  },
  {
    ...
    url: "https://redis.io/",
    category: "Databases",
    description: "Ultra-fast in-memory data store used for caching, queues, and real-time data.",
  },
  {
    name: "sqlite",
    label: "SQLite",
